...
function BWP_SetVars()
	...
	if(BWP_Options.X == nil) then BWP_Options.X = 500; end
	if(BWP_Options.Y == nil) then BWP_Options.Y = 600; end
end
...
function BWP_OptionsInit()
	...
	BWP_MainFrame:ClearAllPoints();
	BWP_MainFrame:SetPoint("TOPLEFT", "UIParent", "BOTTOMLEFT",BWP_Options.X,BWP_Options.Y)
